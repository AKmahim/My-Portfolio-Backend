...
<head>
    ...
    <link href="{{ asset('admin') }}/lib/owlcarousel/{{asset('frontend')}}/owl.carousel.min.css" rel="stylesheet">
...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="{{url('admin/dashboard')}}" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>XR Interactive</h3>
                </a>
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                ...
                <div>
                    <a href="{{ url('/')}}" class="nav-link " target="_blank">
                        ...
                        <span class="d-none d-lg-inline-flex">View Site</span>
                    </a>
                </div>
                ...
                <div class="bg-secondary rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="#">XR Interactive</a>, All Right Reserved. 
                        </div>
    ...
    <!-- Template Javascript -->
    <script src="{{ asset('admin') }}/js/main.js?v=4234"></script>
</body>
